      ...
      <section className="bg-gradient-to-br from-primary via-primary to-primary/80 text-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#daftar"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary rounded-xl font-semibold hover:bg-accent transition-colors"
            >
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {stats.top_volunteers.map((v, i) => (
                <div key={i} className="text-center p-5 rounded-xl bg-white shadow-sm">
                  ...
                  <p className="text-sm font-bold text-primary mt-1">{v.total_points.toLocaleString('id-ID')} poin</p>
                </div>
              ))}
            </div>
          </div>
